...
internal class TextRes
{
    ...
    public static string GetEnText(string key) =>
        key switch
        {
            ...
            "_you_visisted_cell" => "{0} you visited #{1}",
            "_player_paid" => "{0} paid ${1}",
            "_player_paid_to_user" => "{0} paid ${1} to {2}",
            "_player_paid_to_exit_from_jail" => "player {0} paid $500 and exited from jail",
